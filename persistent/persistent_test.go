...
var _ = Describe("persistent", func() {
	...
	Context("allocate test", func() {
		...
		BeforeEach(func() {
			// persistent = &persistent.Persistent{}
			request1.Values = make([]persistent.ValueRequest, 5)
			...
			request2.Values = make([]persistent.ValueRequest, 1)
		...
		Context("not defined", func() {
			BeforeEach(func() {
				request4.Values = make([]persistent.ValueRequest, 1)
		...
		Context("release", func() {
			BeforeEach(func() {
				request3.Values = make([]persistent.ValueRequest, 1)
		...
		Context("compsite operation", func() {
			BeforeEach(func() {
				...
				request1.Values = make([]persistent.ValueRequest, 1)
				request1.Plan = "plan1"
